...
CREATE DATABASE IF NOT EXISTS `knn` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `knn`;

-- Dumping structure for table knn.data_testing
...
-- Dumping data for table knn.data_testing: ~10 rows (approximately)
/*!40000 ALTER TABLE `data_testing` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `data_testing` ENABLE KEYS */;

-- Dumping structure for table knn.data_testing_normalized
CREATE TABLE IF NOT EXISTS `data_testing_normalized` (
  `data_id` int(11) NOT NULL AUTO_INCREMENT,
  `data_name` varchar(200) NOT NULL,
  `data_semester` double NOT NULL,
  `data_IPK` double NOT NULL,
...
-- Dumping data for table knn.data_testing_normalized: ~10 rows (approximately)
/*!40000 ALTER TABLE `data_testing_normalized` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `data_testing_normalized` ENABLE KEYS */;

-- Dumping structure for table knn.data_uji
...
-- Dumping data for table knn.data_uji: ~0 rows (approximately)
/*!40000 ALTER TABLE `data_uji` DISABLE KEYS */;
/*!40000 ALTER TABLE `data_uji` ENABLE KEYS */;

-- Dumping structure for table knn.data_uji_normalized
...
-- Dumping data for table knn.data_uji_normalized: ~36 rows (approximately)
...
INSERT INTO `data_uji_normalized` (`data_id`, `user_id`, `data_semester`, `data_IPK`, `data_gaji_ortu`, `data_UKT`, `data_tanggungan`, `data_label`, `tetangga_terdekat`) VALUES
	(10, 12, 0.3333, 0.6667, 0.125, 1.2529, 0.5, 1, '0.6129864'),
	(11, 13, 0, 0, -0.125, 1.1353, 0.6667, 1, '1.0858964'),
	(12, 14, 1, 0.2222, -0.025, 1.0294, 0.6667, 1, '0.7577635'),
	(13, 15, 0.6667, 0, 0.25, 1.1176, 0.3333, 1, '0.89210675'),
	(14, 16, 0.6667, 0.7778, -0.075, 0.8824, 0.1667, 1, '0.4950774'),
	(15, 17, 0.6667, -0.3889, 0.7488, 1.0235, 0.5, 0, '1.277047'),
	(16, 18, 1, -0.0778, 0.39, 1.4176, 0.6667, 1, '1.19300675'),
	(17, 19, 0.3333, -0.3333, 0.6375, 1.4765, 1, 1, '1.5695355'),
	(18, 20, 0.6667, -0.3778, 0.465, 1.1, 0, 0, '1.1653015'),
	(19, 21, 0.3333, 0.6667, 0.125, 1.2529, 0.5, 1, '0.6129864'),
	(20, 22, 0, 0, -0.125, 1.1353, 0.6667, 1, '1.0858964'),
	(21, 23, 1, 0.2222, -0.025, 1.0294, 0.6667, 1, '0.7577635'),
	(22, 24, 0.6667, 0, 0.25, 1.1176, 0.3333, 1, '0.89210675'),
	(23, 25, 0.6667, 0.7778, -0.075, 0.8824, 0.1667, 1, '0.4950774'),
	(24, 26, 0.6667, -0.3889, 0.7488, 1.0235, 0.5, 0, '1.277047'),
	(25, 27, 1, -0.0778, 0.39, 1.4176, 0.6667, 1, '1.19300675'),
	(26, 28, 0.3333, -0.3333, 0.6375, 1.4765, 1, 1, '1.5695355'),
	(27, 29, 0.6667, -0.3778, 0.465, 1.1, 0, 0, '1.1653015'),
	(28, 30, 0.3333, 0.6667, 0.125, 1.2529, 0.5, 1, '0.6129864'),
	(29, 31, 0, 0, -0.125, 1.1353, 0.6667, 1, '1.0858964'),
	(30, 32, 1, 0.2222, -0.025, 1.0294, 0.6667, 1, '0.7577635'),
	(31, 33, 0.6667, 0, 0.25, 1.1176, 0.3333, 1, '0.89210675'),
	(32, 34, 0.6667, 0.7778, -0.075, 0.8824, 0.1667, 1, '0.4950774'),
	(33, 35, 0.6667, -0.3889, 0.7488, 1.0235, 0.5, 0, '1.277047'),
	(34, 36, 1, -0.0778, 0.39, 1.4176, 0.6667, 1, '1.19300675'),
	(35, 37, 0.3333, -0.3333, 0.6375, 1.4765, 1, 1, '1.5695355'),
	(36, 38, 0.6667, -0.3778, 0.465, 1.1, 0, 0, '1.1653015'),
	(37, 39, 0.3333, 0.6667, 0.125, 1.2529, 0.5, 1, '0.6129864'),
	(38, 40, 0, 0, -0.125, 1.1353, 0.6667, 1, '1.0858964'),
	(39, 41, 1, 0.2222, -0.025, 1.0294, 0.6667, 1, '0.7577635'),
	(40, 42, 0.6667, 0, 0.25, 1.1176, 0.3333, 1, '0.89210675'),
	(41, 43, 0.6667, 0.7778, -0.075, 0.8824, 0.1667, 1, '0.4950774'),
	(42, 44, 0.6667, -0.3889, 0.7488, 1.0235, 0.5, 0, '1.277047'),
	(43, 45, 1, -0.0778, 0.39, 1.4176, 0.6667, 1, '1.19300675'),
	(44, 46, 0.3333, -0.3333, 0.6375, 1.4765, 1, 1, '1.5695355'),
	(45, 47, 0.6667, -0.3778, 0.465, 1.1, 0, 0, '1.1653015');
/*!40000 ALTER TABLE `data_uji_normalized` ENABLE KEYS */;

-- Dumping structure for table knn.log
...
-- Dumping data for table knn.log: ~1,836 rows (approximately)
...
-- Dumping structure for table knn.user
...
-- Dumping data for table knn.user: ~1 rows (approximately)
...
-- Dumping structure for table knn.user_profile
...
-- Dumping data for table knn.user_profile: ~1 rows (approximately)
